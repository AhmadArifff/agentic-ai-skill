...
| **cast** & **paint** | [`.agents/skills/cast/`](file:///c:/Users/ASUS/Documents/Web%20Dev/improving/agentic%20AI/.agents/skills/cast) & [`.agents/skills/paint/`](file:///c:/Users/ASUS/Documents/Web%20Dev/improving/agentic%20AI/.agents/skills/paint) | `ui-ux-designer`, `frontend-engineer` | Creative coding Genjutsu: `/cast` (The Illusionist) untuk mikro-interaksi & motion; `/paint` (The Master Painter) untuk desain visual anti-AI-slop & design system audit. |
| **_jutsu** | [`.agents/skills/_jutsu/`](file:///c:/Users/ASUS/Documents/Web%20Dev/improving/agentic%20AI/.agents/skills/_jutsu) | `frontend-engineer`, `ui-ux-designer` | 15 sub-keahlian kreatif: canvas-generative, compose-motion, swiftui-motion, threejs-r3f, gsap, css-native, design-audit. |
| **design-dna** | [`.agents/skills/design-dna/`](file:///c:/Users/ASUS/Documents/Web%20Dev/improving/agentic%20AI/.agents/skills/design-dna) | `ui-ux-designer`, `frontend-engineer` | Ekstraksi dan penegakan identitas visual (Design Tokens JSON, qualitative style, effects) dari screenshot/URL referensi. |
| **threejs suite** | [`.agents/skills/threejs-fundamentals/`](file:///c:/Users/ASUS/Documents/Web%20Dev/improving/agentic%20AI/.agents/skills/threejs-fundamentals) | `frontend-engineer`, `ui-ux-designer` | 10 modul spesialis 3D/WebGL: fundamentals, geometry, materials, lighting, textures, animation, loaders, shaders, postprocessing, interaction. |
